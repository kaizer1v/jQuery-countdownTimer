...
(function($) {
  ...
  // only hours are set when invoking plugin.
  ...
  // only minutes are set when invoking plugin.
  ...
  // only seconds are set when invoking plugin.
  ...
  // hours and minutes are set when invoking plugin.
  ...
  // minutes and seconds are set when invoking plugin.
  ...
  // hours and seconds are set when invoking plugin.
  ...
  // hours, minutes and seconds are set when invoking plugin.
  ...
  // called when no options are set - default.
  ...
  // calling the given function name when time is expired.
  ...
  // calling the given function name before expiry time.
